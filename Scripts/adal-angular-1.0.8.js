            ...
            return {
                request: function (config) {
                    if (config) {
                        ...
                        // TODO :: Clear this hack once we have 2 seperate client IDs for WebAPI and UI apps.
                        // HACK : [specific to Facility Planner to allow same AAD app clientID for Facility Planner webAPI and UI apps.]
                        if (authService.config.clientId == resource) {
                            resource = authService.config.loginResource;
                        }
                        // <- End of HACK
